...
#define DCO_VERSION_SHORT 4.4
#define DCO_VERSION 4.4.1
#define DCO_BRANCH
#define DCO_COMPATIBILITY_VERSION_BASE 360000

#define DCO_VERSION_MAJOR 4
#define DCO_VERSION_MINOR 4
...
#define DCO_COMPATIBILITY_VERSION                                                                                      \
  (DCO_COMPATIBILITY_VERSION_BASE + DCO_CHUNK_TAPE_N + DCO_TAPE_USE_LONG_INT_N + DCO_TAPE_USE_INT64_N + 8 +            \
   DCO_AUTO_SUPPORT_N)
...
template <int T> const std::string build_info_t<T>::VERSION = "4.4.1";
template <int T> const std::string build_info_t<T>::VERSION_SHORT = "4.4";
template <int T> const std::string build_info_t<T>::BRANCH = "";
template <int T> const int build_info_t<T>::VERSION_MAJOR = 4;
template <int T> const int build_info_t<T>::VERSION_MINOR = 4;
